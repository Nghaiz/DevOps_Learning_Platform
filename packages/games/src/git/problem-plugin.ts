...
/*
 * `GIT_PROBLEM_TOPICS` chuyển sang `./problem-topics.ts` ngày 2026-09-15, và
 * chỗ đứng mới là cả điểm của lượt chuyển: file NÀY nhập `createGitSession`,
 * nên mọi route chạm một tên trong đây đều kéo engine git theo. Trang danh mục
 * bài chỉ cần nhãn chủ đề. Lý do "vì sao tám chủ đề, vì sao tập đóng, vì sao id
 * để trần" đi theo dữ liệu sang file mới — đọc ở đó.
 */
