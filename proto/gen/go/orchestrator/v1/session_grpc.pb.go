...
func (c *sessionServiceClient) ClaimSession(ctx context.Context, in *ClaimSessionRequest, opts ...grpc.CallOption) (*ClaimSessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ClaimSessionResponse)
	err := c.cc.Invoke(ctx, SessionService_ClaimSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionServiceClient) ReapSession(ctx context.Context, in *ReapSessionRequest, opts ...grpc.CallOption) (*ReapSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, SessionService_ReapSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSessionServiceServer) ClaimSession(context.Context, *ClaimSessionRequest) (*ClaimSessionResponse, error) {
...
func _SessionService_ClaimSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClaimSessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionServiceServer).ClaimSession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionService_ClaimSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServiceServer).ClaimSession(ctx, req.(*ClaimSessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SessionService_ReapSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(SessionServiceServer).ReapSession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionService_ReapSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServiceServer).ReapSession(ctx, req.(*ReapSessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orchestrator.v1.SessionService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SessionService_ClaimSession_Handler,
		},
		{
	...
	Metadata: "orchestrator/v1/session.proto",
}
