...
- [ ] Từ **101 tới `ready`**: **p95 < 500ms** (`dlp_gateway_attach_duration_seconds`), ≥ 50 mẫu. *(Câu chữ sửa 2026-08-12 ở 1.G-1; phép đo thuộc **1.G-2 M1**.)*
