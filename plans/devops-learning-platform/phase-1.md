...
> **Tiến độ:** ✅ **1.C-1 XONG (G1, G2, G3, G11, G13 + bước i của G8)** — 2026-08-10. Toàn bộ **chín bước kiểm trước upgrade** của contract §3 chạy thật; chủ hợp lệ nhận **101** + echo `dlp.terminal.v1`, mọi ca khác nhận đúng mã của bảng dưới. Sau đó: **1.C-2 XONG** (G4–G6) 2026-08-10, **G12 XONG** 2026-08-11. **Còn nợ: G7–G10** (keepalive/`ExtendSession`, phần còn lại của rate-limit, stateless, metrics) — gộp thành **1.C-3**.
>
...
| 1.C gateway (G1–G13) | **L** · **1.C-1 ✅ xong 2026-08-10** (G1, G2, G3, G11, G13 + bước i) · **1.C-2 ✅ xong 2026-08-10** (G4–G6, cầu exec — **đã gõ được lệnh thật trên cluster**) · **G12 ✅ xong 2026-08-11** (cookie thật, 18/18 e2e — R25 ĐÓNG) · **1.C-3** G7–G10 (extend, rate-limit, metrics) còn nợ | Đường găng, song song 1.B. **1.F hết bị chặn bởi G12** kể từ 2026-08-11; còn chặn bởi WS contract + B0.4 (cả hai đã xong) ⇒ lane FE mở được ngay. |
