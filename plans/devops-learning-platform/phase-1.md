...
> **Còn nợ của lane (KHÔNG tick):** bốn ô warm-pool/reaper — replenish ≤30s + 3 session đồng thời, tín hiệu chạm quota, pod mồ côi/session ma → `FAILED`, quarantine tầng 3. Chúng phải đẩy cụm tới **trần quota 4 pod** (D16) nên chạy riêng, không chung lượt với các ca trên; baseline đã chụp sẵn trong report để lần đo sau có mốc so.
>
