...
| Đường ống CI/CD | `cicd` | **Đã có engine CI/CD và web chương CI (14 level).** 19.G đang bổ sung C15–C28; chưa tích hợp CD vào web, chưa nghiệm thu AC-G. <!-- updated 260917 --> | [`phase-19.md`](../../plans/devops-learning-platform/phase-19.md) §0b, §19.G |
